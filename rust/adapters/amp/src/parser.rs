...
struct AmpThread {
    #[serde(
        default,
        deserialize_with = "turbotokens_adapter_common::jsonl::non_empty_string"
    )]
    id: Option<String>,
    #[serde(
        default,
        deserialize_with = "turbotokens_adapter_common::jsonl::lenient_vec"
    )]
    messages: Vec<AmpMessage>,
    #[serde(
        default,
        deserialize_with = "turbotokens_adapter_common::jsonl::lenient_object"
    )]
...
struct AmpUsageLedger {
    #[serde(
        default,
        deserialize_with = "turbotokens_adapter_common::jsonl::lenient_array"
    )]
